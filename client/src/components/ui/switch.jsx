...
const Switch = React.forwardRef(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    ...
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-[0.9rem] w-[0.9rem] rounded-full bg-card shadow-lg ring-0 transition-transform data-[state=checked]:translate-x-[0.9rem] data-[state=unchecked]:translate-x-0"
      )} />
  </SwitchPrimitives.Root>
))
